...
import { analyzeProject, defaultReadmeOptions, generateDeterministicReadme, scoreReadme, renderScoreBar, saveReadmeToProject, } from "@readmeforge/core";
const COMMANDS = ["analyze", "generate", "check", "preview"];
function printHelp() {
